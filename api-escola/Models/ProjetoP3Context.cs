...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Aluno>(entity =>
        {
            ...
            entity.Property(e => e.TxNome).HasMaxLength(100).HasColumnName("tx_nome");
            entity.Property(e => e.TxSexo).HasMaxLength(1).IsFixedLength().HasColumnName("tx_sexo");
        });

        modelBuilder.Entity<Cursa>(entity =>
        {
            entity.HasKey(e => new { e.IdAluno, e.IdDisciplina, e.InAno, e.InSemestre }).HasName("PRIMARY").HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0, 0, 0 });
            ...
            entity.Property(e => e.NmNota1).HasPrecision(4, 2).HasColumnName("nm_nota1");
            entity.Property(e => e.NmNota2).HasPrecision(4, 2).HasColumnName("nm_nota2");
            entity.Property(e => e.NmNota3).HasPrecision(4, 2).HasColumnName("nm_nota3");
        ...
        modelBuilder.Entity<Curso>(entity =>
        {
            ...
            entity.Property(e => e.TxDescricao).HasMaxLength(150).HasColumnName("tx_descricao");
        ...
        modelBuilder.Entity<Disciplina>(entity =>
        {
            ...
            entity.Property(e => e.TxDescricao).HasMaxLength(150).HasColumnName("tx_descricao");
            entity.Property(e => e.TxSigla).HasMaxLength(10).HasColumnName("tx_sigla");
        ...
        modelBuilder.Entity<Instituicao>(entity =>
        {
            ...
            entity.Property(e => e.IdInstituicao).HasColumnName("id_instituicao");
            entity.Property(e => e.TxDescricao).HasMaxLength(150).HasColumnName("tx_descricao");
            entity.Property(e => e.TxSigla).HasMaxLength(15).HasColumnName("tx_sigla");
        });
        ...
        modelBuilder.Entity<Professor>(entity =>
        {
            ...
            entity.Property(e => e.TxEstadoCivil).HasMaxLength(1).HasDefaultValueSql("'S'").IsFixedLength().HasColumnName("tx_estado_civil");
            entity.Property(e => e.TxNome).HasMaxLength(50).HasColumnName("tx_nome");
            entity.Property(e => e.TxSexo).HasMaxLength(1).HasDefaultValueSql("'M'").IsFixedLength().HasColumnName("tx_sexo");
            entity.Property(e => e.TxTelefone).HasMaxLength(13).HasColumnName("tx_telefone");

            entity.HasOne(d => d.IdTituloNavigation).WithMany(p => p.Professors)
                .HasForeignKey(d => d.IdTitulo)
                .HasConstraintName("professor_ibfk_1");

            entity.HasMany(p => p.Lecionas)
                .WithOne(l => l.Professor)
                .HasForeignKey(l => l.IdProfessor)
                .HasConstraintName("leciona_ibfk_1");
        });

        modelBuilder.Entity<Leciona>(entity =>
        {
            entity.HasKey(e => new { e.IdProfessor, e.IdDisciplina }).HasName("PRIMARY");
